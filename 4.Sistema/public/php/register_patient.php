            ...
            <div class="form-group " >
                ...
                <div class="form-row">
                    <div class="form-group col-md-2">
                        <input type="password" class="form-control" id="password" name="f_senha"  placeholder="Senha *" required/>
                    </div>



                    <div class="form-group col-md-2">
                        <input type="text" name="f_telefone" class="form-control" id="telefone"  placeholder="Telefone *" required/>
                    </div>
                ...
                <div class="form-row " >
                    ...
                    <div class="form-group col-md-2.3">
                        <select id="cargo"  class="form-control"   name="f_raca" style=" width: 250px;">
                            ...
                            <option value="assistente">Branco</option>
                            <option value="gerente">Negro</option>
                            <option value="pecuarista">Pardo</option>
                            <option value="tesoureiro">Amarelo</option>
                            <option value="veterinario">Indígena</option>
                        </select>
                    </div>

                    <div class="form-group " >
                        <input type="number" class="form-control" name="f_sus" id="nSus" placeholder="N Sus *" style=" width: 258px;" required/>
                    </div>
                ...
                <div class="form-row"  >
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input id="cidade" name="f_cidade" type="text" class="form-control" id="inputCity" placeholder="Cidade * ">
                    </div>
                ...
                <div class="form-group">
                    <input type="text" name="f_complemento" class="form-control" id="inputAddress2" placeholder="Complemento. Qd. Lt. Nº" required/>
                </div>

                <div class="form-group">
                    <input type="text" name="f_alergia" class="form-control" id="alergia" placeholder="Alergia "/>
                </div>

                <div class="form-group">
                    <input type="text" name="f_local_nascimento" class="form-control" id="local_nascimento" placeholder="Cidade no qual Nasceu *" required/>
                </div>

                <div class="form-group">
                    <input type="text" name="f_tipo_pessoa" class="form-control" id="tipo_pessoa" readonly value="Paciente" required/>
                </div>
