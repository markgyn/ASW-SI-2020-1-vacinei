...
<div class="content-container">
    ...
    <div class="container-fluid">
        ...
        <div class="jumbotron">
            <h1>Bem vindo <?php echo $_SESSION['userName'] ? $_SESSION['userName'] : $_COOKIE['u_name'];
            ...
            <p>
                <a class="btn btn-lg btn-primary" href="schedule_vaccine.php" role="button">Agendar Vacina &raquo;</a>
            </p>
        </div>
